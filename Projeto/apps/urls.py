...
urlpatterns = [
    ...
    path('programas/editar/<int:pk>/', views.ProgramaUpdateView.as_view(), name='programa_update'),
    ...
    path('programa/<int:pk>/delete/', ProgramaDeleteView.as_view(), name='programa_delete'),
]